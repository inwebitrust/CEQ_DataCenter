...
$query = "SELECT country_code, start_year, end_year, indicator_id, decile, indicator_value FROM ".$DBTABLES["datavalues_decile"]." WHERE indicator_id IN (".$indicatorsString.")";
